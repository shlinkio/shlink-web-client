...
const Se = "shlink-web-client", We = "A React-based progressive web application for shlink", Be = "/shlink-web-client/dependabot/npm_and_yarn/testing-library/user-event-14.5.1", qe = "https://github.com/shlinkio/shlink-web-client", Fe = "MIT", He = {
