...
function de(s) {
  return typeof s == "function" ? ue(s) : (s instanceof IDBTransaction && le(s), re(s, ie()) ? new Proxy(s, T) : s);
}
function f(s) {
...
const Se = "shlink-web-client", We = "A React-based progressive web application for shlink", Be = "/shlink-web-client/dependabot/npm_and_yarn/react-router-dom-6.21.2", qe = "https://github.com/shlinkio/shlink-web-client", Fe = "MIT", He = "module", Ve = {
