  ...
  async cachePut(e, t) {
    ...
    try {
      ...
      if (h instanceof Error)
        throw h.name === "QuotaExceededError" && await je(), h;
    }
...
function Xe(s) {
  const e = O(), t = new ze(e, s);
  S(t);
}
function Ye(s) {
  return O().createHandlerBoundToURL(s);
}
function Ze(s) {
  O().precache(s);
}
...
const nt = "shlink-web-client", rt = "A React-based progressive web application for shlink", at = "/shlink-web-client/dependabot/npm_and_yarn/stylelint-15.10.3", it = "https://github.com/shlinkio/shlink-web-client", ct = "MIT", ot = {
