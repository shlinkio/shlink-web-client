...
class V {
  ...
  handleAll(e) {
    ...
    const t = e.event, n = typeof e.request == "string" ? new Request(e.request) : e.request, r = "params" in e ? e.params : void 0, a = new ve(this, { event: t, request: n, params: r }), i = this._getResponse(a, n, t), c = this._awaitComplete(i, a, n, t);
    return [i, c];
  }
...
const Se = "shlink-web-client", We = "A React-based progressive web application for shlink", Be = "/shlink-web-client/feature/improve-router-tests", qe = "https://github.com/shlinkio/shlink-web-client", Fe = "MIT", He = "module", Ve = {
