...
class _e {
  ...
  constructor(e = {}) {
    ...
    }, this._config = e, this._maxAgeSeconds = e.maxAgeSeconds, this._cacheExpirations = /* @__PURE__ */ new Map(), e.purgeOnQuotaError && Q(() => this.deleteCacheAndMetadata());
  }
  /**
...
let y;
const Ue = () => (y || (y = new ve(), y.addFetchListener(), y.addCacheListener()), y);
function M(s, e, t) {
  let n;
  if (typeof s == "string") {
...
const Se = "shlink-web-client", We = "A React-based progressive web application for shlink", Be = "/shlink-web-client/feature/react-tag-autocomplete-7", qe = "https://github.com/shlinkio/shlink-web-client", Fe = "MIT", He = {
