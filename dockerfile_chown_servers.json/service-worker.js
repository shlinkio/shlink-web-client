...
const Se = "shlink-web-client", We = "A React-based progressive web application for shlink", Be = "/shlink-web-client/dockerfile_chown_servers.json", qe = "https://github.com/shlinkio/shlink-web-client", Fe = "MIT", He = "module", Ve = {
